 ...
 * hole in solid.
 *
 * Size it with className (size-5); it carries none of its own. There is only
 * this one drawing: no compact variant, no boxed icon version. A second
 * drawing is a second logo to keep in sync, and it drifts.
 */
