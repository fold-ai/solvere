...
const FILES: { name: string; use: string; preview: React.ReactNode }[] = [
  {
    ...
    use: "The mark on its own, currentColor. The one to reach for by default.",
    ...
    <div className="flex flex-1 flex-col">
      ...
      <main className="flex-1">
        ...
        <Section
          ...
          title="One drawing, down to twenty pixels."
          note="Below 20px the 2.2-unit ring and the 1.4-unit gap each land on less than a pixel and the mark muddies. There is deliberately no second, simplified drawing to cover that: a second drawing is a second logo to keep in sync, and it will drift. Below 20px, set the wordmark on its own. The browser tab icon is the one accepted exception, because a tab is recognised by silhouette and colour rather than by detail."
        >
          <Panel>
            <PanelHead right="minimum 20px">Sizes</PanelHead>
        ...
        <Section label="07 · Misuse" title="Six things that break it.">
          <div className="grid grid-cols-2 gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-3">
            ...
            <Dont
              note="No violet tile, no circle, no card. There is one drawing, and a container around it is a second logo nobody agreed to."
              lead="Do not box it."
            >
              <span className="grid size-11 place-items-center rounded-[22.5%] bg-[#8E5EED]">
                <SolvereMark className="size-7 text-white" />
              </span>
            </Dont>
          </div>
        </Section>
        ...
        <Section label="08 · In use" title="Where it actually appears.">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-[1.4fr_1fr]">
            <Panel>
              ...
              <PanelHead right="mark 14px, muted">Panel header</PanelHead>
              <div className="flex items-center gap-2 px-4 py-3 text-[0.6875rem] tracking-[0.12em] text-muted-foreground uppercase">
                <SolvereMark className="size-3.5" aria-hidden />
                Audit record
              </div>
            </Panel>

            <Panel>
              <PanelHead right="lockup">Email signature</PanelHead>
              <div className="p-6">
                <div className="flex items-center gap-[0.6875rem]">
                  <SolvereMark className="size-[26px]" />
                  <span className="text-xl font-semibold tracking-tight">Solvere</span>
                </div>
              ...
              <p className="border-t border-border px-4 py-2.5 text-xs text-muted-foreground">
                Outline the wordmark first. A signature renders in whatever the recipient has
                installed, and that is not Geist.
              </p>
            </Panel>
          </div>
        </Section>
